...
@Controller
@ServerEndpoint("/alertFeverServer")
public class WebsocketAlertFeverServer {
    ...
    public void sendMessage(AlertFever alertFever) {  
        for (Map.Entry<String, Session> entry : sessionMap.entrySet()) {
            try {
                entry.getValue().getBasicRemote().sendText(JsonUtil.objToJson(MapUtil.createMap("depName", alertFever.getDepName(), "count", alertFever.getCount())));
            } catch (IOException e) {
