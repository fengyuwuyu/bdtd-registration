PatientInHospitalComprehensiveQuery = {
	drawChart: function() {
		...
		Feng.ajaxAsyncJson(Feng.ctxPath + '/comprehensive/sickRestChart', queryData, function(data) {
			if (!data.data) {
				return;
			}
			data = data.data;
	...
	close: function() {
		parent.layer.close(window.parent.PatientInHospitalComprehensiveQuery.layerIndex);
	},
